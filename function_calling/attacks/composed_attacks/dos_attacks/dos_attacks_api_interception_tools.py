...
class DosAttackApiInterceptionToolsModification(Attack):
    def __init__(
        self,
        name,
        description,
        num_requests=100,
        max_workers=50,
        scenario_file="./tests/test_tool_injection_api_interception_scenarios.json",
    ):
    ...
    def execute(self, messages, agent, llm_judge):
        ...
        for scenario in self.scenarios:
            ...
            forced_function = scenario["modified_prompt"]
            scenario_results = {
