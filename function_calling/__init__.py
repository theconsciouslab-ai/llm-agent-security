...
class ResultSaver:
    ...
    def batch_generate_attack_analysis_csvs(root_dir="results"):
        """
        Processes all JSON files in the results directory structure and generates CSV files
        for each one using generate_attack_analysis_excel()
        """
...
ResultSaver.batch_generate_attack_analysis_csvs()
