...
from attacks.simple_attacks.prompt_injections.system_prompt_injection import SystemPromptModifier
from attacks.simple_attacks.prompt_injections.user_prompt_injection import MessageBuilder
...
class MCPPromptInjectionChain(MCPAttack):
    def __init__(self, name: str, description: str, scenario_file: str = "./tests/test_chained/one_step_chained/test_chain_prompt_injection.json"):
